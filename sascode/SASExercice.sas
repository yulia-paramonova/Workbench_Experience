...
**  EXERCICE SAS :                                                                    **;
**                                                                                    **;
**  Pour cet exercice, votre objectif est de déboguer le code ci-dessous.             **;
**  Exécutez le code du début à la fin, puis localisez et corrigez les trois erreurs  **;
**  qui l'empêchent de s'exécuter correctement.                                       **;
****************************************************************************************;
